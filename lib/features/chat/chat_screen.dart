  ...
  Widget build(BuildContext context) => Scaffold(
        body: Chat(
          ...
          theme: DefaultChatTheme(
            primaryColor: CustomColors.primaryColor.withOpacity(.9),
            inputBackgroundColor: Colors.black.withOpacity(.8),
            userAvatarImageBackgroundColor: CustomColors.secondaryColor,
